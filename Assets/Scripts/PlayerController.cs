...
public class PlayerController : MonoBehaviourPunCallbacks, IPunObservable
{
    ...
    public void Initialize (Player player)
    {
        ...
        // if this isn't our local players, disable physics as that's controlled by the user and synced to all other clients
    ...
    // check if we are grounded and if so, jump
    void TryJump ()
    {
